				...
				<table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
					...
					<tr>
						<td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
							class="main-header">
                            <div style="line-height: 35px">NOTICE OF REQUEST TRAINING RESCHEDULE</div>
						</td>
					</tr>
                    ...
                    <tr>
                        <td style="color: #343434; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                            <strong><i><u><?php echo $content['training_request']['contact_person']; ?></u></i></strong> of <strong><i><u><?php echo $content['training_request']['company_name'];?></u></i></strong> is requesting to reschedule the training.
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="color: #343434; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                            You may reach this customer at this contact details : <u style="font-weight:bold;font-style:italic;"><?php echo $content['training_request']['contact_number'];?></u>
                        </td>
                    </tr>
