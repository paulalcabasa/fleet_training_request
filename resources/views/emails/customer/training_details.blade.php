				...
				<table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    ...
                    <tr>
                        <td style="color: #343434; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                            We would like to thank you for having Isuzu conduct training for your company. As  preparation, kindly refer to the following details.
                        </td>
                    </tr>
					...
					<tr style="color: #343434; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; ">
                        <td style="width:100%;">	 
                            <table style="width:100%;color:#343434;border-collapse:collapse;border:1px solid #000;" cellpadding="10" border="1">
								<tr>
								...
								<tr>
									<td colspan="2"  align="center" style="font-size:14px;font-weight:bold;">TRAINING REMINDERS	</td>
								</tr>
