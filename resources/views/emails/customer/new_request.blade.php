								...
								<tr>
									<td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
										<div style="line-height: 24px">
											Greetings! Your request for training has been submitted. You will receive an email confirmation once your request is validated by an Isuzu representative.
										</div>
									</td>
								</tr>
							</table>
