				...
				<table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    ...
                    <tr>
                        <td style="color: #343434; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                            This is to inform you that <span style="font-style:italic;font-weight:bold;"><u><?php echo $content['training_request']['contact_person']; ?></u></span>  of <span style="font-style:italic;font-weight:bold;"><u><?php echo $content['training_request']['company_name'];?></u></span> is requesting for a training.
                        </td>
                    </tr>
					...
					<tr style="color: #343434; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; ">
                        <td style="width:100%;">	 
                            <table style="width:100%;color:#343434;">
                                ...
                                <?php if(count($content['training_request']['trainors']) > 0) { ?>
                                <tr>
