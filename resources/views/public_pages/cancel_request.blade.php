                ...
                <v-container>
                    <template>
                        <div>
                            ...
                            <v-form v-model="valid" v-if="message == '' && status == 'approved'">
                                <v-container fluid>
                                    <v-card  class="mx-auto"
                                        max-width="400"
                                        outlined>
                                        <v-card-title>Are you sure to cancel the training request?</v-card-title>
            ...
            var app = new Vue({
                ...
                data() {
                    return {
                        ...
                        training_request_id: {!! json_encode($data['training_request_id']) !!},
                ...
                methods: {
                    cancel(){
                        var self = this;
                        axios.post(self.base_url + '/customer/cancel_training_request',{
